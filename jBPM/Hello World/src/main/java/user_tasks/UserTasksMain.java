 ...
 */
public class UserTasksMain {
    
    public static final void main(String[] args) {
        // load up the knowledge base
        KieSession ksession = createKieSession("user_tasks_session");
        
        ksession.getWorkItemManager().registerWorkItemHandler("Human Task", new MyTaskHandler());
       
        Map<String, Object> paramsMap = new HashMap<>();
        
        paramsMap.put("actor", "ivan");
        paramsMap.put("input_param", "input_param_val");
        
        // start a new process instance with a process name and params
        ksession.startProcess("user_tasks_proces", paramsMap);
    }
